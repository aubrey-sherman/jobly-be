...
describe("POST /companies", function () {
  ...
  test("unauth wrong user with missing data", async function () {
    const resp = await request(app)
      .post("/companies")
      .send({
        handle: "new",
...
describe("GET /companies", function () {
  ...
  // TODO: low priority: could add tests for anon, admin, any logged-in user
});
...
describe("PATCH /companies/:handle", function () {
  ...
  test("unauth wrong user for no such company", async function () {
    const resp = await request(app)
      .patch(`/companies/nope`)
      .send({
        name: "new nope",
